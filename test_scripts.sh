...
##STDIN a y b
#cat $test_data/disease_cluster, $test_data/disease_gene | intersect_columns.py $test_data/disease_gene -a'-' -b '-' -A 0 -B 0 > $out/intersect_columns_default_stdin_a_b
##count = true
intersect_columns.py -a $test_data/disease_cluster -b $test_data/disease_gene -A 0 -B 0 -c true 1> $out/intersect_columns_count
##keep = 'ab'
#intersect_columns.py -a $test_data/disease_cluster -b $test_data/disease_gene -A 0 -B 0 -k 'ab' > $out/intersect_columns_ab
##full = true
intersect_columns.py -a $test_data/disease_cluster -b $test_data/disease_gene -A 0 -B 0 --full true 1> $out/intersect_columns_full
...
table_linker.py -i $test_data/disease_cluster -l $test_data/disease_gene -o $out/linked_table_matches --drop true
